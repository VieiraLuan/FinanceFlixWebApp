export const phrases = {
  //Alert generic titles
  error: 'Erro',
  info: 'Informação',
  warning: 'Atenção',
  sucess: 'Sucesso',
  selectAtLeastOne: 'Selecione ao menos um item',
  yes: 'Sim',
  no: 'Não',
  ...
  categoryAddedSuccess: 'Categoria adicionada com sucesso',
  ...
  //Alert specific phrases
  writeValidEmail: 'Informe um email válido',
  writePassword: 'Informe uma senha válida',
